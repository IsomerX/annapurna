    ...
    return(
        <div className="w-full my-0 py-0 flex bg-black text-white">
            <div className="pt-20 w-[60%] flex flex-col px-10">
                ...
                <p className="pt-10">According to FAO estimates in 'The State of Food Security and Nutrition in the World', 2020 report, 189.2 million people are undernourished in India. By this measure, 14% of the population is undernourished in India. We plan to change this. However, to tackle this problem, we need support from NGOs all over the country to help in distribution of food from various sources.
                </p>
                </div>
                <div className="flex flex-row gap-2 items-start pt-10 underline text-xl pl-5">
                    <p>Become a part</p>
                    <img src = "/static/images/external link.svg" className="w-4 pb-14 self-center"/>
                </div>
            </div>
            <div className="w-[40%]">
